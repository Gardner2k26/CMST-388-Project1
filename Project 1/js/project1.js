document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    document.querySelector("#add-classes").addEventListener('click', () => {
        ...
        document.querySelectorAll('.selector-examples li:nth-child(even)').forEach(el => {
    ...
    */
    ...
    document.querySelector("#change-language").addEventListener('click', () => {
        ...
        const element = document.querySelectorAll('.currentLanguage');
